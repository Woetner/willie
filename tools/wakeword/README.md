...
VIRTUAL_ENV=$PWD/.venv .uvenv/bin/uv pip install -e ./microWakeWord torch torchaudio piper-phonemize-cross==1.2.1 scipy tensorboard "datasets==3.6.0" soundfile librosa
